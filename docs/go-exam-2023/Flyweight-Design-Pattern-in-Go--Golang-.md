...
> 来源：[`golangbyexample.com/flyweight-design-pattern-golang/`](https://golangbyexample.com/flyweight-design-pattern-golang/)

注意：如果您想了解如何在 GO 中实现所有其他设计模式，请查看此完整参考 – [Go 中的所有设计模式（Golang）](https://golangbyexample.com/all-design-patterns-golang/)
...
1.  每个 10 个玩家对象都会创建不同的服装对象并嵌入它们。将创建总共 10 个服装对象。
