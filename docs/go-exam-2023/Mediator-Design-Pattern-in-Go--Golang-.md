...
> 来源：[`golangbyexample.com/mediator-design-pattern-golang/`](https://golangbyexample.com/mediator-design-pattern-golang/)

注意：有兴趣了解如何在 GO 中实现所有其他设计模式，请查看此完整参考 – [Go 中的所有设计模式](https://golangbyexample.com/all-design-patterns-golang/)
